...
**Kuva 1:** _Eri mallisia tensoreita. Skaalarilla ei ole ulottuvuuksia, vektorilla on yksi, matriisilla kaksi ja korkeamman asteen tensoreilla kolme tai enemmän ulottuvuuksia._
...
**Kuva 2:** _Kuvassa on 2-2-1 arkkitehtuuria edustava verkko, `NumpyNNwithBCE`, jota käytämme tämän luvun aikana esimerkkinä. Toteutuksesta löytyy Jupyter Notebook, jossa verkko on toteuttuna NumPy:lla._
...
[^whypythonslow]: VanderPlas, J. _Why is Python slow?_ https://jakevdp.github.io/blog/2014/05/09/why-python-is-slow/

[^whynumpyfast]: Numpy. _Why is NumPy fast?_ https://numpy.org/doc/stable/user/whatisnumpy.html#why-is-numpy-fast
